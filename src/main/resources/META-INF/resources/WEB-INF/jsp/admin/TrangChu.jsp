				...
				<div class="card shadow-sm border-0">
					...
					<div class="card-body">
						<ul class="list-group list-group-flush">
							<li class="list-group-item">📂 Quản lý loại câu hỏi</li>
							<li class="list-group-item">📝 Tạo và quản lý bộ câu hỏi
								trắc nghiệm</li>
							<li class="list-group-item">👨‍🏫 Quản lý tài khoản giảng
								viên</li>
							<li class="list-group-item">👨‍🎓 Quản lý tài khoản sinh
								viên</li>
							<li class="list-group-item">📊 Theo dõi hệ thống</li>
						</ul>
					</div>
				</div>
			</div>
